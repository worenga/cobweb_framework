 ...
 * ************************************************************************************************ 
 * Filename: cobweb.form.password.element.php
 * Author: Benedikt Wolters (mightyuhu@php.net)
 * License:  MIT License
 * Version: $Id: cobweb.form.password.element.php 19 2009-09-12 13:40:15Z mightyuhu $;
 * ************************************************************************************************
 * Description:
 * Helper Class, CobWeb_FormPasswordElement. All Functions of the PasswordElement are included here. 
 * ************************************************************************************************
 */
if (! defined('cw_inc')) {
...
class CobWeb_FormPasswordElement extends CobWeb_FormElement
{
    private $defaultValue = null;
    //Settings keys: wrapperclass, maxlenght, id
    ...
    public function render ($validation = false)
    {
        ...
        $textElement->setAttrib('type','password');
    ...
    protected function equalsTo($validateWith,$fieldname){
        if(strcmp($this->validateWith[$fieldname],$validateWith) === 0){
            return true;
        }else{
            return false;
        }
